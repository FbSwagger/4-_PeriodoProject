<?php
    ...
    $query = "INSERT INTO atividades (nome_atividade, tipo_atividade,status_valor, duracao_atividade,hora,data_atividade,sala,carga,valor) VALUES ('{$nome_atividade}', '{$tipo_atividade}', '{$atividade_valor}', '{$atividade_duracao}','{$atividade_hora}','{$atividade_data}','{$atividade_sala}','{$atividade_carga}','{$valor_atividade}')"; 

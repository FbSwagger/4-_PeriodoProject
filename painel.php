            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <form class="form-inline pull-right ng-pristine ng-valid">
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn botao" ng-click="#">
                                            <i class="mdi mdi-calendar"></i>    
                                        Agenda
                                    </button>
                                </div>
                                <div class="form-group">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle botao" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        ...
                                                        <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" aria-label="Exemplo do tamanho do input" aria-describedby="inputGroup-sizing-default" required>
                                                        </div>
                                                        <div class="row">
                                                            
                                                            <div class="form-group space">
                                                                    <select  class="form-control ng-pristine ng-valid ng-empty ng-touched" st-delay="0" >
                                                                        <option ng-value="null" value="object:null" selected="selected">Defina o tipo</option>
                                                                        <option ng-value="true" value="boolean:true">Apresentação cultural</option>
                                                                        <option ng-value="false" value="boolean:false">Palestra</option>
                                                                    </select>
                                                            </div>
                                                            <div class="form-group">
                                                                    <select  class="form-control ng-pristine ng-valid ng-empty ng-touched" st-delay="0" >
                                                                        <option ng-value="null" value="object:null" selected="selected">Inscrição</option>
                                                                        <option ng-value="true" value="boolean:true">Gratuita</option>
                                                                        <option ng-value="false" value="boolean:false">Paga</option>
                                                                        <option ng-value="false" value="boolean:false">Não requer inscrição</option>
                                                                    </select>
                                                            </div>
                                                            <div class="form-group space">
                                                                    <select  class="form-control ng-pristine ng-valid ng-empty ng-touched" st-delay="0" >
                                                                        <option ng-value="null" value="object:null" selected="selected">Duração</option>
                                                                        <option ng-value="true" value="boolean:true">Um dia</option>
                                                                        <option ng-value="false" value="boolean:false">Dois dias</option>
                                                                        <option ng-value="false" value="boolean:false">Três dias</option>
                                                                    </select>
                                                            </div>
                                                ...
                                                <button type="button" class="btn btn-verde">Salvar Atividade</button>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                    <table class="table table-hover tabela-size">
                                            <thead>
                                                <tr>
                                                    <!---->
                                                    <th>

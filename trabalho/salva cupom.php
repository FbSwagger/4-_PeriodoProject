          ...
          <ul id="sidebarnav">
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link"
                href="../tela-admin(MENU COMPLETO)/nice-html/ltr/index.html" aria-expanded="false">
          ...
          <div class="col-md-8">
            <div ng-controller="Atividade">
              <ul class="nav nav-tabs space">
                <li class="">
                  <a href="http://localhost/projeto/painel.php"><button type="button"
                      class="btn btn-light">Atividades</button></a>
                </li>
                <li class="">
...
<?php
           ...
           <form  method="POST"action="cupomdesc.php">
            codigo: <input type="text" name="codigo" placeholder="codigo ">
            desconto:  <input type="text" name="valor " placeholder="valor" autocomplete="off">
            valor: <input type="text" name="Quantidade" placeholder="Quantidade Disponivel " autocomplete="off">
            data de validade: <input type="text" name="data de validade" placeholder="Periodo de validade ">
